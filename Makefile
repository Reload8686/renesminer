...
abs_srcdir=	/home/reload/Python-3.10.5
abs_builddir=	/home/reload/Python-3.10.5
...
# This goes into $(exec_prefix)
LIBPL=		$(prefix)/lib/python3.10/config-$(VERSION)$(ABIFLAGS)-aarch64-linux-gnu
